        ...
        <View style={styles.section}>
          ...
          <View style={styles.sectionBody}>
            ...
            <View style={styles.rowWrapper}>
              ...
              >
                <FeatherIcon
                  ...
                  style={{ marginRight: 12 }}
                />
                <Text style={styles.rowLabel}>Antrin Poliklinik</Text>
                <View style={styles.rowSpacer} />
                <FeatherIcon color="#bcbcbc" name="chevron-right" size={19} />
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.rowWrapper}>
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate("rujukan", userData);
                }}
                style={styles.row}
              >
                <FeatherIcon
                  ...
                  style={{ marginRight: 12 }}
                />
                <Text style={styles.rowLabel}>Rujukan Pasien</Text>
                <View style={styles.rowSpacer} />
                <FeatherIcon color="#bcbcbc" name="chevron-right" size={19} />
              </TouchableOpacity>
            </View>
            ...
            <View style={[styles.rowWrapper, styles.rowLast]}>
              ...
              >
                <FeatherIcon
                  ...
                  style={{ marginRight: 12 }}
                />
                <Text style={styles.rowLabel}>Mobile Ambulance</Text>
                <View style={styles.rowSpacer} />
                <FeatherIcon color="#bcbcbc" name="chevron-right" size={19} />
              </TouchableOpacity>
            </View>
